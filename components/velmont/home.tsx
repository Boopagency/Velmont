...
function ContactForm() {
  ...
  return <form className="contact-form" onSubmit={e => {
    ...
    <p className="form-privacy">Ao continuar, o WhatsApp abre com sua mensagem preparada. Você revisa e envia por lá. <a href="/privacidade">Privacidade</a></p>
